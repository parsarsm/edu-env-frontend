                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <CardTitle className="mb-1 d-flex">
                                ...
                                <Button color="link" size="sm" className="pt-0 mr-auto">
                ...
                <Card className="mb-3">
                    ...
                    <ListGroup flush>
                        <ListGroupItem className="d-flex">
                            <span>My Cash</span>
                            <CustomInput type="switch" id="exampleCustomSwitch" name="customSwitch" label="" className="mr-auto" />
                        </ListGroupItem>
                        <ListGroupItem className="d-flex">
                            <span>My Cap</span>
                            <CustomInput type="switch" id="exampleCustomSwitch1" name="customSwitch" label="" className="mr-auto" defaultChecked />
                        </ListGroupItem>
                        <ListGroupItem className="d-flex">
                            <span>Client List</span>
                            <CustomInput type="switch" id="exampleCustomSwitch2" name="customSwitch" label="" className="mr-auto" defaultChecked />
                        </ListGroupItem>
                        <ListGroupItem className="d-flex">
                            <span>Recent Fundings</span>
                            <CustomInput type="switch" id="exampleCustomSwitch3" name="customSwitch" label="" className="mr-auto" />
                        </ListGroupItem>
                        <ListGroupItem className="d-flex">
                            <span>Invoice Creator</span>
                            <CustomInput type="switch" id="exampleCustomSwitch4" name="customSwitch" label="" className="mr-auto" />
                        </ListGroupItem>
                        <ListGroupItem className="d-flex">
                            <span>Sales Lead</span>
                            <CustomInput type="switch" id="exampleCustomSwitch5" name="customSwitch" label="" className="mr-auto" defaultChecked />
                        </ListGroupItem>
                        <ListGroupItem className="d-flex">
                            <span>Q&A</span>
                            <CustomInput type="switch" id="exampleCustomSwitch6" name="customSwitch" label="" className="mr-auto" defaultChecked />
                        </ListGroupItem>
                    </ListGroup>
                </Card>
            </Col>
