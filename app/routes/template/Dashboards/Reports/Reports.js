                ...
                <Card>
                    <CardBody className="bb-0">
                        <span className="d-flex">
                            ...
                            <span className="mr-auto justify-content-start">
                                <a href="javascript:;" className="mr-auto justify-content-start pr-2 text-decoration-none" id="TemperaturesTooltipSettings">
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="TemperaturesProcessorToggler" className="by-0 d-flex text-decoration-none">
                            Processor
                            <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="TemperaturesProcessorTooltip"></i>
                        </ListGroupItem>
                    ...
                    <UncontrolledCollapse toggler="#TemperaturesProcessorToggler" isOpen>
                        <CardBody className="pt-0">
                            <span className="d-flex mb-4">
                                <h1>39º</h1>
                                <span className="mr-auto text-right">
                                    102º F <br />
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="TemperaturesGraphicsToggler" className="by-0 d-flex text-decoration-none">
                            Graphics
                            <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="TemperaturesGraphicsTooltip"></i>
                        </ListGroupItem>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="TemperaturesStorageToggler" className="by-0 d-flex text-decoration-none">
                            Storage
                            <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="TemperaturesStorageTooltip"></i>
                        </ListGroupItem>
                        ...
                        <CardBody className="pt-0">
                            ...
                            <div className="mb-3">
                                ...
                                <div className="d-flex justify-content-between">
                                    ...
                                    <Progress value="25" className="mt-2 w-50 progress" style={{height: "5px"}} />
                                    <span className="mr-2 text-inverse">31º</span>
                                </div>
                            </div>
                            <div className="mb-3">
                                <span className="d-flex">
                                ...
                                <div className="d-flex justify-content-between">
                                    ...
                                    <span className="mr-2 text-inverse">81º</span>
                                </div>
                            </div>
                            <div className="mb-0">
                                <span className="d-flex">
                                ...
                                <div className="d-flex justify-content-between">
                                    ...
                                    <span className="mr-2 text-inverse">21º</span>
                                </div>
                            </div>
                        </CardBody>
                    </UncontrolledCollapse>
                ...
                <Card className="mb-sm-4 mb-xl-0">
                    <CardBody className="bb-0">
                        <span className="d-flex">
                            ...
                            <span className="mr-auto justify-content-start">
                                <a href="javascript:;" className="mr-auto justify-content-start pr-2 text-decoration-none" id="UsageTooltipSettings">
                                    <i className="fa fa-fw fa-sliders"></i>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="ProcessorToggler" className="by-0 d-flex text-decoration-none">
                            Processor
                            <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="ProcessorTooltip"></i>
                        </ListGroupItem>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="UsageLoadToggler" className="by-0 d-flex text-decoration-none">
                            Usage (Load)
                            <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="UsageLoadTooltip"></i>
                        </ListGroupItem>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="GraphicsToggler" className="by-0 d-flex text-decoration-none">
                            Graphics
                            <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="GraphicsTooltip"></i>
                        </ListGroupItem>
                    ...
                    <ListGroup flush>
                        <ListGroupItem tag="a" href="#" id="UsageLoadToggler2" className="by-0 d-flex text-decoration-none">
                            Usage (Load)
                            <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="UsageLoadTooltip2"></i>
                        </ListGroupItem>
                        ...
                        <Card className="mb-4">
                            <CardBody className="bb-0">
                                <span className="d-flex">
                                    ...
                                    <span className="mr-auto justify-content-start">
                                        <a href="javascript:;" className="mr-auto justify-content-start pr-2 text-decoration-none" id="AllocationTooltipSettings">
                                            <i className="fa fa-fw fa-sliders"></i>
                            ...
                            <ListGroup flush>
                                <ListGroupItem tag="a" href="#" id="RamToggler" className="by-0 d-flex text-decoration-none">
                                    RAM
                                    <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="RamTooltip"></i>
                                </ListGroupItem>
                        ...
                        <Card className="mb-4">
                            <CardBody className="bb-0">
                                <span className="d-flex">
                                    ...
                                    <span className="mr-auto justify-content-start">
                                        <a href="javascript:;" className="mr-auto justify-content-start pr-2 text-decoration-none" id="CoolingTooltipSettings">
                                            <i className="fa fa-fw fa-sliders"></i>
                            ...
                            <ListGroup flush>
                                <ListGroupItem tag="a" href="#" id="FansToggler" className="by-0 d-flex text-decoration-none">
                                    Fans
                                    <i className="fa fa-fw fa-angle-down mr-auto justify-content-end" id="FansTooltip"></i>
                                </ListGroupItem>
                                ...
                                <CardBody className="pt-0">
                                    <div className="mb-2">
                                        <span className="d-flex">
                                            ...
                                            <span className="mr-auto text-inverse">
                                                120mm
                                            </span>
                                        </span>
                        ...
                        <Card>
                            <CardBody className="bb-0 pb-0">
                                <span className="d-flex">
                                    ...
                                    <span className="mr-auto justify-content-start">
                                        <a href="javascript:;" className="mr-auto justify-content-start pr-2" id="ActivityTooltipSettings">
                                            <i className="fa fa-fw fa-sliders"></i>
