    ...
    <React.Fragment>
        ...
        <Nav vertical pills className="mb-3">
            <NavItem>
                <NavLink href="#" className="small d-flex px-1">
                    ...
                    <i className="fa fa-angle-down align-self-center mr-auto"></i>
                </NavLink>
            </NavItem>
            <NavItem>
                <NavLink tag={ RouterNavLink } to="/apps/search-results" className="d-flex">
                    All Results
                    <Badge pill color="secondary" className="mr-auto align-self-center">
                        12
                    </Badge>
                </NavLink>
            </NavItem>
        ...
        <Nav vertical className="mb-3">
            ...
            <NavItem>
                <NavLink href="#" className="d-flex">
                    ...
                    <span className="small mr-auto align-self-center text-body">
                        ({ faker.finance.mask() })
                    </span>
                </NavLink>
            </NavItem>
        ...
        <Nav vertical className="mb-3">
            ...
            <NavItem className="d-flex px-2 mb-2">
                ...
                <span className="small mr-auto align-self-center">
                    ({ faker.finance.mask() })
                </span>
            </NavItem>
            <NavItem className="d-flex px-2 mb-2">
