            ...
            <Nav pills vertical>
                <NavItem>
                    <NavLink href="#" className="d-flex">
                        ...
                        Analytics Redesign
                        <Badge color="secondary" pill className="mr-auto align-self-center">
                            12
                        </Badge>
                    </NavLink>
                </NavItem>
            ...
            <Nav pills vertical>
                <NavItem>
                    <NavLink href="#" className="d-flex">
                        ...
                        <i className="fa fa-fw fa-circle text-success mr-auto align-self-center mr-2"></i>
                    </NavLink>
                </NavItem>
                <NavItem>
                    <NavLink href="#" className="d-flex">
                        ...
                        <i className="fa fa-fw fa-circle text-warning mr-auto align-self-center mr-2"></i>
                    </NavLink>
                </NavItem>
                <NavItem>
                    <NavLink href="#" className="d-flex">
                        ...
                        <i className="fa fa-fw fa-circle text-danger mr-auto align-self-center mr-2"></i>
                    </NavLink>
                </NavItem>
                <NavItem>
                    <NavLink href="#">
