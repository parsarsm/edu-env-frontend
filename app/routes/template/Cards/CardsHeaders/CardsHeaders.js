                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <CardTitle tag="h6" className="d-flex">
                                Default Small Text
                                <Badge className="mr-2 mr-auto" color="primary">
                                    Updated
                                </Badge>
                            </CardTitle>
                            <CardTextDemo 
                ...
                <Col lg={ 6 }>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <CardTitle tag="h6" className="d-flex">
                                Header Right Icon 
                                <i className="fa fa-gear mr-auto"></i>
                            </CardTitle>
                            <CardTextDemo 
                                cardNo="1.07"
                            />
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <CardTitle tag="h6" className="d-flex">
                                ...
                                <Badge className="mr-2 mr-auto" color="primary" pill>
                                    New
                                </Badge>
                            </CardTitle>
                            <CardTextDemo 
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                ...
                                <Pagination size="sm" aria-label="Page navigation example" className="mr-auto">                                    <PaginationItem>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex mb-3">
                                ...
                                <Button outline size="sm" className="mr-auto">
                                    Button
                                </Button>
                            </div>
                            <CardTextDemo 
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex mb-3">
                                ...
                                <Button color="link" size="sm" className="mr-auto pt-0">
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex mb-3">
                                ...
                                <ButtonGroup vertical size="sm" className="mr-auto">
                                    <Button outline>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex mb-3">
                                ...
                                <UncontrolledButtonDropdown className="mr-auto">
                                    <DropdownToggle size="sm" outline caret>
                                       Menu
                                    </DropdownToggle>
                                    <DropdownMenu right>
                ...
                <Col lg={ 6 }>
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                ...
                                <CustomInput type="checkbox" className="mr-auto" id="rightCheckbox" label="On/Off" />
                            </div>
                            <CardTextDemo 
                                cardNo="4.01"
                            />
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                ...
                                <CustomInput type="checkbox" className="mr-auto" id="rightCheckboxEmpty" label="" />
                            </div>
                            <CardTextDemo 
                                cardNo="4.03"
                            />
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                <CardTitle tag="h6">
                                    <CustomInput type="checkbox" className="mr-auto" id="leftCheckbox" label="Left Checkbox" inline />
                                </CardTitle>
                            </div>
                            <CardTextDemo 
                                cardNo="4.04"
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                ...
                                <CustomInput type="radio" className="mr-auto" id="rightRadio" label="Select" />
                            </div>
                            <CardTextDemo 
                                cardNo="4.05"
                            />
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex">
                                <CardTitle tag="h6">
                                    <CustomInput type="radio" className="mr-auto" id="leftRadio" label="Left Radio" />
                                </CardTitle>
                            </div>
                            <CardTextDemo 
                                cardNo="4.06"
                        ...
                        <CardBody>
                            <div className="d-flex mb-3">
                                ...
                                <Form inline className="mr-auto">
                                    <FormGroup>
                                        <CustomInput type="select" id="exampleCustomSelect" name="customSelect" bsSize="sm" className="mr-auto">
                    ...
                    <Card className="mb-3">
                        <CardBody>
                            <div className="d-flex mb-3">
                                ...
                                <Form inline className="mr-auto">
                                    <FormGroup>
                                        <Input type="text" bsSize="sm" name="text" id="text" className="mr-auto" placeholder="Search..." />
                                    </FormGroup>
                                </Form>
                            </div>
                            <CardTextDemo 
                                ...
                                <Form inline className="mr-auto">
                                    <FormGroup>
                                        <InputGroup size="sm">
                                            ...
                                            <Input type="text" name="text" id="text" className="mr-auto" placeholder="Enter Price..." />
                                        </InputGroup>
                                    </FormGroup>
                                </Form>
                            </div>
                                ...
                                <Form inline className="mr-auto">
                                    <FormGroup>
                                        <InputGroup size="sm">
                                            ...
                                            <Input type="text" name="text" id="text" className="mr-auto" placeholder="Enter Nick..." />
                                        </InputGroup>
                                    </FormGroup>
                                </Form>
                            </div>
                                ...
                                <Form inline className="mr-auto">
                                    <FormGroup>
                                        <InputGroup size="sm">
                                            ...
                                            <Input type="text" name="text" id="text" className="mr-auto" placeholder="Enter..." />
                                        </InputGroup>
                                    </FormGroup>
                                </Form>
                            </div>
                                ...
                                <Form inline className="mr-auto">
                                    <FormGroup>
                                        <InputGroup size="sm">
                                            ...
                                            <Input type="text" name="text" id="text" className="mr-auto" placeholder="0.00" />
                                            <InputGroupAddon addonType="append">
                                                <Button color="primary">
                                                    Add
                                                </Button>
