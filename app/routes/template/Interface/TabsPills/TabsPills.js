                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" active className="d-flex">
                                        Profile
                                        <i className="fa fa-fw fa-user mr-auto align-self-center"></i>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex">
                                        Settings
                                        <i className="fa fa-fw fa-gear mr-auto align-self-center"></i>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" disabled>
                                        Logout
                                        <i className="fa fa-fw fa-sign-out mr-auto align-self-center"></i>
                                    </NavLink>
                                </NavItem>
                            </Nav>
                        </CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" active>
                                        ...
                                        Profile
                                        <i className="fa fa-fw fa-angle-right mr-auto align-self-center"></i>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex">
                        ...
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" active>
                                        Profile
                                        <Badge color="secondary" pill className="mr-auto align-self-center">3</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex">
                                        Settings
                                        <Badge color="secondary" pill className="mr-auto align-self-center">15</Badge>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" disabled>
                                        Logout
                                        <Badge color="secondary" pill className="mr-auto align-self-center">986</Badge>
                                    </NavLink>
                                </NavItem>
                            </Nav>
                        </CardBody>
                        ...
                        <CardBody>
                            ...
                            <Nav pills vertical>
                                <NavItem>
                                    <NavLink href="#" className="d-flex" active>
                                        Profile
                                        <Badge color="secondary" className="mr-auto align-self-center">
                                            Added
                                        </Badge>
                                    </NavLink>
                                </NavItem>
