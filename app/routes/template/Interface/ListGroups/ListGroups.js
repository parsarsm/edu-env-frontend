                ...
                <Col lg={ 6 }>
                    ...
                    <div className="mb-5">
                        ...
                        <p>
                            ...
                            <code>&lt;Badge pill className="mr-auto align-self-center"&gt;14&lt;/Badge&gt;</code>.
                        </p>
                        <ListGroup>
                            <ListGroupItem className="justify-content-between d-flex">
                                Cras justo odio 
                                <Badge pill className="mr-auto align-self-center">14</Badge>
                            </ListGroupItem>
                            <ListGroupItem className="justify-content-between d-flex">
                                Dapibus ac facilisis in
                                <Badge pill className="mr-auto align-self-center">2</Badge>
                            </ListGroupItem>
                            <ListGroupItem className="justify-content-between d-flex">
                                Morbi leo risus
                                <Badge pill className="mr-auto align-self-center">1</Badge>
                            </ListGroupItem>
                        </ListGroup>
                    </div>
                    { /* END Example */}
