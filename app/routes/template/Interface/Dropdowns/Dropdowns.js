                            ...
                            <UncontrolledButtonDropdown>
                                ...
                                <DropdownMenu persist>
                                    <DropdownItem header className="d-flex">
                                        Menu
                                        <i className="fa fa-angle-down mr-auto"></i>
                                    </DropdownItem>
                                    <DropdownItem>Profile</DropdownItem>
                                    <DropdownItem>Settings</DropdownItem>
                                    <DropdownItem divider />
                            ...
                            <UncontrolledButtonDropdown>
                                ...
                                <DropdownMenu persist>
                                    ...
                                    <DropdownItem className="d-flex">
                                        Profile
                                        <i className="fa fa-fw fa-user align-self-center mr-auto"></i>
                                    </DropdownItem>
                                    <DropdownItem className="d-flex">
                                        Settings
                                        <i className="fa fa-fw fa-gear align-self-center mr-auto"></i>
                                    </DropdownItem>
                                    <DropdownItem divider />
                                    <DropdownItem className="d-flex">
                                        Logout
                                        <i className="fa fa-fw fa-sign-out align-self-center mr-auto"></i>
                                    </DropdownItem>
                                </DropdownMenu>
                            </UncontrolledButtonDropdown>
                        </CardBody>
                        ...
                        <CardBody>
                            ...
                            <UncontrolledButtonDropdown>
                                ...
                                <DropdownMenu persist>
                                    ...
                                    <DropdownItem className="d-flex">
                                        Profile
                                        <Badge color="primary" className="align-self-center mr-auto">
                                            Done
                                        </Badge>
                                    </DropdownItem>
                                    <DropdownItem className="d-flex">
                                        Settings
                                        <Badge color="danger" className="align-self-center mr-auto">
                                            Error
                                        </Badge>
                                    </DropdownItem>
                                    <DropdownItem divider />
                                    <DropdownItem className="d-flex">
                                        Logout
                                        <Badge color="success" className="align-self-center mr-auto">
                                            Safe
                                        </Badge>
                                    </DropdownItem>
                                </DropdownMenu>
                        ...
                        <CardBody>
                            ...
                            <UncontrolledButtonDropdown>
                                ...
                                <DropdownMenu persist>
                                    ...
                                    <DropdownItem className="d-flex">
                                        Profile
                                        <Badge pill color="primary" className="align-self-center mr-auto">
                                            5
                                        </Badge>
                                    </DropdownItem>
                                    <DropdownItem className="d-flex">
                                        Settings
                                        <Badge pill color="danger" className="align-self-center mr-auto">
                                            12
                                        </Badge>
                                    </DropdownItem>
                                    <DropdownItem divider />
                                    <DropdownItem className="d-flex">
                                        Logout
                                        <Badge pill color="success" className="align-self-center mr-auto">
                                            34
                                        </Badge>
                                    </DropdownItem>
                                </DropdownMenu>
